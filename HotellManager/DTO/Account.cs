...
namespace DTO
{
    public class Account
    {
        ...
        public string IdStaffType { get => idStaffType; set => idStaffType = value; }
        ...
        #region Constructor
        public Account() { }
        public Account(string userName, string displayName, string passWord, string staffType, string idCard, DateTime dateOfBirth, string sex, string address, int phoneNumber, DateTime startDay)
        {
        ...
        public Account(DataRow row)
        {
            ...
            this.idStaffType = row["IDStaffType"].ToString();
